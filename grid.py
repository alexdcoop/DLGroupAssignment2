...
def param_tune(estimator):
    param_grid = [{'batch_size':[], 'num_hid_layers':[1,], 'num_hid_neurons':[], 'hid_activation':['sigmoid', 'tanh','relu','elu','leaky relu','elu'], 'optimizer':['SGD','momentum','nesterov','adagrad','rmsprop','adam','learning rate scheduling']}]
